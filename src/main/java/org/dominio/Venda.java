...
public class Venda {
    ...
    public Venda(Long id, Cliente cliente, Usuario usuario, BigDecimal totalDaVenda, BigDecimal valorPago, BigDecimal desconto, BigDecimal troco, LocalDate dataHoraCriacao, LocalDate ultimaAtualizacao) {
        this.id = id;
